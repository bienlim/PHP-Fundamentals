...
<body>
    ...
    <nav class="navbar navbar-light border-bottom border-dark main-nav sticky-top bg-light">
        <div class="container-fluid"> 
            ...
            <div class="d-flex">
                <a class="btn btn-light ms-12" href="<?=base_url('products')?>">Dashboard</a>
                <a class="btn btn-light ms-12" href="<?=base_url('users/profile')?>">My Profile</a>
                <a class="btn btn-light ms-12" href="<?=base_url('users/logout')?>">Log out</a>
