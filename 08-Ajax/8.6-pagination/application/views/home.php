...
<meta charset="utf-8">
	...
	<script>
		$(document).ready(function(){
			$.get( 
				"searches/index_html/"+<?=$_SESSION['page']?> , 
				function(res) {
        ...
        $(document).on('click','a', function()
			{
				var card=$(this);
				$.post(card.attr("href"),card.serialize(),function(res) {
					$('#searchOutput').html(res);}
				);
				return false;
			}
...
<body >
    <div class="container">
        <header class ="row">
            <form class="col-12" action="searches/index_html/1" method="post">
        ...
        <section id="searchOutput" class ="row">
        </section>
    </div>
</body>
</html>
